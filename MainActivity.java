...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        statePreferences = getSharedPreferences("shiftpay_state", MODE_PRIVATE);
    ...
    public class AndroidStorageBridge {
        ...
        public String loadState() {
            return statePreferences.getString("state_json", "");
        }

        @JavascriptInterface
        public void saveState(String json) {
            if (json == null || json.isBlank()) return;
            // commit() is intentional here: the shift state must be durable before
            // JavaScript continues, including if Android kills the process immediately.
            statePreferences.edit().putString("state_json", json).commit();
        }

        @JavascriptInterface
        public void clearState() {
            statePreferences.edit().remove("state_json").commit();
        }
    }
